...
Doorkeeper.configure do
  ...
  resource_owner_authenticator do
    # For API-only applications, we'll use token-based authentication
    # This will be called when accessing protected resources
    User.find_by(id: doorkeeper_token.resource_owner_id) if doorkeeper_token
  end

  # Resource owner authentication for password grant
  ...
  # Grant flows - only password grant for API
  ...
  # Skip client authentication for password grant (for simplicity in development)
