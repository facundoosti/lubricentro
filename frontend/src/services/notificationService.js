...
// Helpers por entidad
export const showCustomerSuccess = (action) => showSuccess(MESSAGES.CUSTOMER[action]);
export const showCustomerError = (action, detail) =>
  showError(MESSAGES.CUSTOMER[action], detail);

export const showVehicleSuccess = (action) => showSuccess(MESSAGES.VEHICLE[action]);
export const showVehicleError = (action, detail) =>
  showError(MESSAGES.VEHICLE[action], detail);

export const showProductSuccess = (action) => showSuccess(MESSAGES.PRODUCT[action]);
export const showProductError = (action, detail) =>
  showError(MESSAGES.PRODUCT[action], detail);

export const showServiceSuccess = (action) => showSuccess(MESSAGES.SERVICE[action]);
export const showServiceError = (action, detail) =>
  showError(MESSAGES.SERVICE[action], detail);

export const showAppointmentSuccess = (action) => showSuccess(MESSAGES.APPOINTMENT[action]);
export const showAppointmentError = (action, detail) =>
  showError(MESSAGES.APPOINTMENT[action], detail);

export const showServiceRecordSuccess = (action) => showSuccess(MESSAGES.SERVICE_RECORD[action]);
